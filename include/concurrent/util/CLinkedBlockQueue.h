 ...
 */
CLinkedBlockingQueue *LinkedBlockingQueue_new(uint32_t blockSize);

/**
 * delete a linked blocking queue object
 * @param queue queue object
 */
void LinkedBlockingQueue_delete(CLinkedBlockingQueue *queue);
 ...
 */
bool LinkedBlockingQueue_offer(CLinkedBlockingQueue *queue,
                               const void *src,
                               uint32_t len);
 ...
 */
bool LinkedBlockingQueue_peek(CLinkedBlockingQueue *queue,
                              void *dst,
                              uint32_t *len);
 ...
 */
bool LinkedBlockingQueue_poll(CLinkedBlockingQueue *queue,
                              void *dst,
                              uint32_t *len);
 ...
 */
bool LinkedBlockingQueue_isEmpty(const CLinkedBlockingQueue *queue);
 ...
 */
int32_t LinkedBlockingQueue_size(const CLinkedBlockingQueue *queue);
