...
class ConcurrentLinkedQueueImpl {
  ...
  class Node {
   ...
   public:
	...
	GetNext() const;
	void
	SetNext(const TaggedNodePtr &tagged_node_ptr);
	bool
	CasNext(bool weak, TaggedNodePtr &expect, const TaggedNodePtr &update);
  };
  class NodeStack {
 ...
 public:
  bool
  Offer(const Object &value, Object *(*value_func)(Node *));
  bool
  Poll(Object *o, Object *(*value_func)(Node *));
  unsigned
  GetQueueSize() const;
  bool
  IsQueueEmpty() const;
