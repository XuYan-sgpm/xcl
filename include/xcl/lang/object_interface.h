...
public:
  virtual void ArgsConstruct(void *dst, unsigned n, ...) = 0;
  virtual void ArgsConstruct(void *dst, unsigned n, va_list args) = 0;
  virtual void CopyConstruct(void *dst, const void *src) = 0;
  virtual void CopyAssign(void *dst, const void *src) = 0;
  virtual void MoveConstruct(void *dst, void *src) = 0;
  virtual void MoveAssign(void *dst, void *src) = 0;
  virtual void Destroy(void *dst) = 0;
};
} // namespace xcl
