...
class Pipeline : public Object {
 ...
 public:
  ...
  void
  AddFirst(Functional *functional);
  void
  Add(const Pipeline &pipeline);
  void
  Add(Pipeline &&pipeline);
  void
  AddFirst(const Pipeline &pipeline);
  void
  AddFirst(Pipeline &&pipeline);
  Object *
  Fire(bool reverse = false);
  Object *
  Fire(Object *arg, bool reverse = false);
