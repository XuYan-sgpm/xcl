...
RingBuffer_release(RingBuffer* ringBuffer);
...
RingBuffer_size(const RingBuffer* ringBuffer);
 ...
 */
XCL_EXPORT int32_t XCL_API
RingBuffer_capacity(const RingBuffer* ringBuffer);
...
RingBuffer_empty(const RingBuffer* ringBuffer);
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_pushFront(RingBuffer* ringBuffer, const void* src, bool force);
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_pushBack(RingBuffer* ringBuffer, const void* src, bool force);
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_popFront(RingBuffer* ringBuffer, void* dst);
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_popBack(RingBuffer* ringBuffer, void* dst);
 ...
 */
XCL_EXPORT void* XCL_API
RingBuffer_at(RingBuffer* ringBuffer, int32_t pos);
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_get(const RingBuffer* ringBuffer, int32_t pos, void* dst);
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_insert(RingBuffer* ringBuffer,
                  int32_t pos,
                  const void* src,
                  bool force);
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_insertRepeat(RingBuffer* ringBuffer,
                        int32_t pos,
                        int32_t count,
                        const void* src,
                        bool force);
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_insertRegion(RingBuffer* ringBuffer,
                        int32_t pos,
                        const void* src,
                        int32_t es,
                        int32_t len,
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_assignRepeat(RingBuffer* ringBuffer, int32_t n, const void* src);
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_assignRegion(RingBuffer* ringBuffer,
                        const void* src,
                        int32_t es,
                        int32_t len);
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_replace(RingBuffer* ringBuffer,
                   int32_t pos,
                   int32_t n,
                   const void* src);
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_replaceRepeat(RingBuffer* ringBuffer,
                         int32_t pos,
                         int32_t n,
                         int32_t count,
                         const void* src);
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_replaceRegion(RingBuffer* ringBuffer,
                         int32_t pos,
                         int32_t n,
                         const void* src,
                         int32_t es,
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_assignBufRegion(RingBuffer* ringBuffer,
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_assignBuf(RingBuffer* ringBuffer, const RingBuffer* src);
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_insertBufRegion(RingBuffer* ringBuffer,
                           int32_t pos,
                           const RingBuffer* src,
                           int32_t first,
                           int32_t last,
 ...
 */
XCL_EXPORT bool XCL_API
RingBuffer_replaceBufRegion(RingBuffer* ringBuffer,
                            int32_t pos,
                            int32_t n,
                            const RingBuffer* src,
                            int32_t first,
 ...
 * @param obj user specified object for element writing
 * @return total bytes written, not elements
 * @author xuyan
 * @date 2022-08-15
 */
XCL_EXPORT int32_t XCL_API
RingBuffer_writeStream(const RingBuffer* ringBuffer,
                       int32_t pos,
                       int32_t n,
 ...
 */
XCL_EXPORT int32_t XCL_API
RingBuffer_write(const RingBuffer* ringBuffer,
                 int32_t pos,
                 void* dst,
                 int32_t len);
 ...
 */
XCL_EXPORT void XCL_API
RingBuffer_remove(RingBuffer* ringBuffer, int32_t pos, int32_t n);
