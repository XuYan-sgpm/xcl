...
UnitTest &UnitTest::Instance() { return *unit_test_; }
void UnitTest::TestFiles(const char *test_dir, unsigned n, ...) {
  va_list libraries;
  ...
  private:
    void CollectFiles(const char *dir_path) {
    ...
    static char *SkipSpace(char *cursor) {
    ...
    static char *Match(char *cursor, bool *found) {
      *found = false;
