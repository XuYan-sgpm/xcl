...
class ObjectRecyclerImpl : public AbstractObjectRecycler {
 ...
 protected:
  Object *
  NewObject(RecycledHandle *handle) override;
...
Object *
ObjectRecyclerImpl::NewObject(RecycledHandle *handle) {
